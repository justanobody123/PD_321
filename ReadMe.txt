...
TODO:
1. Добавить фильтрацию данных в дочерние классы;
2. Написать метод info(), который автоматизирует вывод информации о фигуре;
3. Добавить в иерархию фигур круг и треугольник;
