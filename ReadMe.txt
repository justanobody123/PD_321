...
TODO:
1. Обеспечить вызов методов дерева без необходимости передачи в них корня;
2. Деструктор дерева должен удалять все элементы дерева;
3. На базе класса 'Tree' написать класс 'UniqueTree', который будет уникальным деревом;
4. Написать метод 'erase', который удаляет элемент по значению;
5. Написать метод 'depth', который возвращает глубину дерева;
