...
void main()
{
	...
	cout << endl;
	clock_t start = clock();	//Функция clock() возвращает количество тактов процессора
	cout << "Минимальное  значение в дереве: " << tree.minValue() << ", вычислино за ";
	clock_t end = clock();
	cout << double(end - start) / CLOCKS_PER_SEC << " секнд.\n";
	//////////////////////////////////////////////////////////////////////////////////////
	start = clock();
