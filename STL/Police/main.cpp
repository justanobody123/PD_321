...
void print(const std::map<LicencePlate, std::list<Crime>>& base, const LicencePlate& start_plate, LicencePlate end_plate);
...
void main()
{
	...
	/*std::map<LicencePlate, std::list<Crime>> base =
	{
		...
		{LicencePlate("m001bb"), {Crime(4, "ул. Космонавтов", "22:20 20.10.2023"), Crime(4, "ул. Космонавтов", "22:30 18.05.2023"), Crime(6, "ул. Космонавтов", "22:33 18.05.2023")}},
